...
public class Inventory {
	...
	// hard code variables to center inventory on screen
	private int invX = 164, invY = 148,
			invWidth = 512, invHeight = 384, 
			invListCenterX = invX + 171,
			invListCenterY = invY + invHeight / 2 + 5,
			invListSpacing = 30;
	
	private int invImageX = 552, invImageY = 182,
			invImageWidth = 64, invImageHeight = 64;
	
	private int invCountX = 584, invCountY = 272;
	// ...
